...
public class Concert {
    ...
    public void addMusic(Music music) {
        ...
        if (this.orchestra != null && this.orchestra.checkOrchestra(music)) {
                    System.out.println("Musica adicionada: " + music.getTitle());
    ...
    public double concertDuration() {
        double sum = 0;
        boolean reachOneHour = false;
        System.out.println("Musicas: " +  musicList.size());
        for (Music music : this.musicList) {
            System.out.println(music.getTitle() + ": " + music.getDuration() + "m");
                sum += music.getDuration();
                sum++;
                if(sum >= 3600 && !reachOneHour){
                    reachOneHour = true;
                    sum+=900;
                }
            }
    ...
    public void showAlignment(double startTime) {
        ...
        for (Music music1 : this.musicList) {
            if (music1 != null) {
    ...
    /**
     * 
     * Returns the list of music pieces that will be performed at the concert.
     * 
     * @return an ArrayList of Music objects representing the concert's music list.
     */
